...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("cebetanc/ipinfo")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("cebetanc/ipinfo", on_message_from_ipinfo)

    #replace user with your USC username in all subscriptions
    client.subscribe("cebetanc/dateinfo")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("cebetanc/dateinfo", on_message_from_dateinfo)

    #replace user with your USC username in all subscriptions
    client.subscribe("cebetanc/timeinfo")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("cebetanc/timeinfo", on_message_from_timeinfo)
